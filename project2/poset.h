...
namespace jnp1 {
    ...
    bool
    poset_add(unsigned long id, char const *value1, char const *value2);
    ...
    bool
    poset_del(unsigned long id, char const *value1, char const *value2);

    //Jeżeli istnieje poset o identyfikatorze id, elementy value1 i value2
    //        należą do tego zbioru oraz element value1 poprzedza element value2, to
    //wynikiem jest true, a w przeciwnym przypadku false.
    bool
    poset_test(unsigned long id, char const *value1, char const *value2);
